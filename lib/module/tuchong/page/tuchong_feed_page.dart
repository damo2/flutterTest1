...
class TuchongFeedWidget extends StatelessWidget {
  @override
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        debugShowCheckedModeBanner: false, home: TuchongFeedPage());
  }
}
class TuchongFeedPage extends BaseWidget {
  @override
  BaseWidgetState<BaseWidget> getState() => _TuchongFeedPageState();
}

class _TuchongFeedPageState extends BaseWidgetState<TuchongFeedPage> with AutomaticKeepAliveClientMixin{
  @override
