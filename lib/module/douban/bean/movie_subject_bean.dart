...
part 'movie_subject_bean.g.dart';

@JsonSerializable()
class MovieSubjectBean extends Object {
  @JsonKey(name: 'rating')
  Rating rating;
  ...
  factory MovieSubjectBean.fromJson(Map<String, dynamic> srcJson) =>
      _$MovieSubjectBeanFromJson(srcJson);

  Map<String, dynamic> toJson() => _$MovieSubjectBeanToJson(this);
}
